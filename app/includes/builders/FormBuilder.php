...
class Markdown_Documenter_FormBuilder
{
    /**
     ...
     *
     * @param  \Illuminate\Html\Markdown_Documenter_HtmlBuilder     $html
     * @param  string                           $csrfToken
     * @return void
     */
    public function __construct(Markdown_Documenter_HtmlBuilder $html)
    {
        $this->html      = $html;
    }
